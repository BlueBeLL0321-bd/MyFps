...
namespace MySample
{
    public class PlayerAniTest : MonoBehaviour
    {
        ...
        {
            // 인풋
            moveX = Input.GetAxis("Horizontal");    // A/D, 좌우 화살표
            moveY = Input.GetAxis("Vertical");      // W/S, 위아래 화살표
        ...
        // 2. 전후좌우 이동 시 전후좌우 애니메이션 플레이
        // 3. 이동이 없을 때에는 대기 애니메이션 플레이
...
/*
1. WASD 입력받아 플레이어 전후좌우 이동하고 (Old Input)
