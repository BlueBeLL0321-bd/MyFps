...
namespace MyFps
{
    ...
    public class Intro : MonoBehaviour
    {
        ...
        // 시작 시퀀스 : 페이드 인 효과, 두리번거리기, 카메라 이동 시작
        ...
        {
            // 1번 포인트 : 두리번거리기, 인트로 UI 보이기
            // 2번 포인트 : 두리번거리기, 인트로 UI 숨기기
            // 3번 포인트 : 두리번거리기, 오두막 앞에서 오두막 라이트 켜기
